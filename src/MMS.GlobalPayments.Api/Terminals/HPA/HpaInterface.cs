...
namespace MMS.GlobalPayments.Api.Terminals.HPA {
    public class HpaInterface : DeviceInterface<HpaController> {
        ...
        public override PaxTerminalResponse Cancel() {
            // TODO: Cancel for HPA?
            throw new ApiException("Cancel Not Implemented");
        }
        ...
        public override PaxTerminalResponse Initialize() {

            throw new ApiException("Initialize Not Implemented"); //NG SDKUPDATE 20/9/2022
        ...
        public override ISignatureResponse PromptForSignature(string transactionId = null) {
            throw new ApiException("PromptForSignature Not Implemented"); //NG SDKUPDATE 20/9/2022
        ...
        public override PaxTerminalResponse Reboot() {
            throw new ApiException("Reboot Not Implemented");
        }

        public override PaxTerminalResponse Reset() {
            //  return _controller.SendAdminMessage<SipBaseResponse>(new HpaAdminBuilder(HPA_MSG_ID.RESET));
            throw new ApiException("Reset Not Implemented");
        }
