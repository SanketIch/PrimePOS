...
namespace MMS.GlobalPayments.Api.Terminals.PAX
{
    public abstract class PaxBaseResponse : DeviceResponse
    {
        ...
        public CashierSubGroup CashierResponse { get; set; }
        ...
        internal PaxBaseResponse(byte[] buffer, params string[] messageIds)
        {
            ...
            using (var br = new BinaryReader(new MemoryStream(buffer)))
            {
                ...
                if (_messageIds.Contains("R03"))
                {
                    ...
                    {
                        logger.Error("ERROR IN TRANSACTIONTYPE : " + ex);
                    }
        ...
        protected virtual void ParseResponse(BinaryReader br)
        {
            ...
            //if (Command != "R03")  // NG 16/9/2022 Reconcilation
            //{
            //    string s = br.ReadToCode(ControlCodes.US);
            //    string s1 = br.ReadToCode(ControlCodes.US);
            //    DeviceResponseText += "\r\n " + s1;
            //}
            if (_messageIds.Contains(Command))
            {
                ...
                switch (Command)
                {
                    case "A09":
                        ...
                        this.Signature_Data = br.ReadToCode(ControlCodes.FS); // GetSignature
                        break;
                    case "A57":
  ...
  public string ReferenceNumber
        ...
        protected virtual void MapResponse()
        {
            ...
            if (AccountResponse != null) {
                MaskedCardNumber = AccountResponse.AccountNumber?.PadLeft(16, '*');//PRIMEPOS-3146
