...
using MMS.GlobalPayments.Api.Terminals.HPA;
using MMS.GlobalPayments.Api.Terminals.Abstractions;
using MMS.GlobalPayments.Api.Terminals.Genius;
using MMS.GlobalPayments.Api.Terminals.UPA;
...
namespace MMS.GlobalPayments.Api.Terminals {
    ...
    public class ConnectionConfig : Configuration, ITerminalConfiguration {
        ...
        public ConnectionConfig() {
            Timeout = -1;
            ReconnectWaitTime = PaxInterface.Default_ReconnectWaitTime; //PRIMEPOS-3087 
        }
