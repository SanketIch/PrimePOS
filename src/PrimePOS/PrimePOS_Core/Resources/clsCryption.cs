...
{
	public sealed class clsCryption
	{
		...
		public clsCryption(string key_val, string iv_val)
		{
			key = new byte[32];
			iv = new byte[32];
		...
		public string NativeDecrypt(string sCrypted)
		{
            string sDecryptedPassword = string.Empty;
            
			NativeEncryption.DecryptText(sCrypted, ref sDecryptedPassword);
