...
namespace POS_Core.Resources
{
    ...
    public class frmWaitScreen : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ultraLabelBtnMsg.Appearance.BackColor = System.Drawing.Color.Red;
        ...
        ////    {
        ////        if (POS.Resources.SigPadUtil.DefaultInstance.SigPadCardInfo != null)
        ////        {
        ////            this.timer1.Stop();
        ...
        ////        }
        ////    }
        ////    else if (POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature != null && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature.Trim() != "")
        ////    {
        ////        if (POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE)
        ////            clsUIHelper.DefaultValue = NOPPUSERCONTINUE;
        ////        if (POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL)
        ////            clsUIHelper.DefaultValue = NOPPUSERCANCEL;
        ////        if ((oWaitFor == WaitFor.CaptureRXSignature && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == RXCAPTURECANCEL) ||
        ////            (oWaitFor == WaitFor.CaptureNOPPSignature && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPCAPTURECANCEL) ||
        ////            (oWaitFor == WaitFor.CaptureNOPPSignature && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL) ||
        ////            (oWaitFor == WaitFor.CaptureNOPPSignature && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE) ||
        ////            (oWaitFor == WaitFor.CaptureCCSignature && POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == SIGNATURECAPTURECANCEL))
        ////        {
        ////            POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature = "";
        ////            closeScreen();
        ////        }
        ////        else if ((POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL)||
        ////            (POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE))
        ////        {
        ////            POS.Resources.SigPadUtil.DefaultInstance.CustomerSignature = "";
        ////        }
        ////        else
        ...
        private void timer1_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
           SigPadUtil.DefaultInstance.PaDResp();
            if(oWaitFor == WaitFor.CreditCardProcess)
            {
                if(SigPadUtil.DefaultInstance.SigPadCardInfo != null)
                {
                    this.timer1.Stop();
                    this.DialogResult = DialogResult.OK;
                    this.Close(); 
            ...
            {
                if(SigPadUtil.DefaultInstance.PINBLOCK != "")
                {
                    this.timer1.Stop();
                    this.DialogResult = DialogResult.OK;
                    this.Close();
            ...
            else if(SigPadUtil.DefaultInstance.CustomerSignature != null && SigPadUtil.DefaultInstance.CustomerSignature.Trim() != "")
            {
                clsCoreUIHelper.DefaultValue = string.Empty; // Added by Manoj 05/04/2011
                if(SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE)
                    clsCoreUIHelper.DefaultValue = NOPPUSERCONTINUE;
                if(SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL)
                    clsCoreUIHelper.DefaultValue = NOPPUSERCANCEL;
                if((oWaitFor == WaitFor.CaptureRXSignature && SigPadUtil.DefaultInstance.CustomerSignature == RXCAPTURECANCEL) ||
                (oWaitFor ==

                WaitFor.CaptureNOPPSignature && SigPadUtil.DefaultInstance.CustomerSignature == NOPPCAPTURECANCEL) ||
                (oWaitFor ==

                WaitFor.CaptureNOPPSignature && SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL) ||
                (oWaitFor ==

                WaitFor.CaptureNOPPSignature && SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE) ||
                (oWaitFor ==

                WaitFor.CaptureCCSignature && SigPadUtil.DefaultInstance.CustomerSignature == SIGNATURECAPTURECANCEL))
                {
                    SigPadUtil.DefaultInstance.CustomerSignature = "";
                    closeScreen();
                }

                else if((SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCANCEL) ||
                (SigPadUtil.DefaultInstance.CustomerSignature == NOPPUSERCONTINUE))
                {
                    SigPadUtil.DefaultInstance.CustomerSignature = "";
                }
                else
        ...
        private void btnCancel1_Click(object sender, EventArgs e)
        {
            ...
            {
                SigPadUtil.DefaultInstance.MsrCancel = true;
            }
        }
    }
