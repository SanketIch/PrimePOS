...
namespace MMSAppUpdater.MMSUpdate {
    using System;
    ...
    public partial class MmsUPdateService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetAlwaysRunningProductListOperationCompleted;
        ...
        public MmsUPdateService() {
            this.Url = global::MMSAppUpdater.Properties.Settings.Default.MMSAppUpdater_MMSUpdate_MmsUPdateService;
        ...
        /// <remarks/>
        public event GetAlwaysRunningProductListCompletedEventHandler GetAlwaysRunningProductListCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetAlwaysRunningProductList", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataSet GetAlwaysRunningProductList(string sAppName) {
            object[] results = this.Invoke("GetAlwaysRunningProductList", new object[] {
                        sAppName});
            return ((System.Data.DataSet)(results[0]));
        }
        
        /// <remarks/>
        public void GetAlwaysRunningProductListAsync(string sAppName) {
            this.GetAlwaysRunningProductListAsync(sAppName, null);
        }
        
        /// <remarks/>
        public void GetAlwaysRunningProductListAsync(string sAppName, object userState) {
            if ((this.GetAlwaysRunningProductListOperationCompleted == null)) {
                this.GetAlwaysRunningProductListOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetAlwaysRunningProductListOperationCompleted);
            }
            this.InvokeAsync("GetAlwaysRunningProductList", new object[] {
                        sAppName}, this.GetAlwaysRunningProductListOperationCompleted, userState);
        }
        
        private void OnGetAlwaysRunningProductListOperationCompleted(object arg) {
            if ((this.GetAlwaysRunningProductListCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetAlwaysRunningProductListCompleted(this, new GetAlwaysRunningProductListCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        public System.Data.DataSet GetFtpCredentials() {
            object[] results = this.Invoke("GetFtpCredentials", new object[0]);
            return ((System.Data.DataSet)(results[0]));
        }
        
        /// <remarks/>
        public void GetFtpCredentialsAsync() {
            this.GetFtpCredentialsAsync(null);
        }
        
        /// <remarks/>
        public void GetFtpCredentialsAsync(object userState) {
            ...
            this.InvokeAsync("GetFtpCredentials", new object[0], this.GetFtpCredentialsOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void GetAlwaysRunningProductListCompletedEventHandler(object sender, GetAlwaysRunningProductListCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetAlwaysRunningProductListCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetAlwaysRunningProductListCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
