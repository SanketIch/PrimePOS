...
namespace POS_Core_UI
{
	...
	/// </summary>
	public class frmItemPriceLogView : System.Windows.Forms.Form
	{
		...
		public frmItemPriceLogView(String ItemID)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("AddedOn");
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("SalePrice");
            Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CostPrice");
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmItemPriceLogView));
            ...
            this.grdHistory.DataMember = null;
            ...
            this.grdHistory.SupportThemes = false;
            ...
            this.lblTransactionType.SupportThemes = false;
            this.lblTransactionType.TabIndex = 26;
            this.lblTransactionType.Tag = "Header";
            this.lblTransactionType.Text = "Item Price Change View";
            // 
            // groupBox2
            // 
            ...
            this.Name = "frmItemPriceLogView";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Item Price Change View";
            this.Activated += new System.EventHandler(this.frmRptItemPriceLog_Activated);
		...
		private void Display() 
		{
			DataSet oData;
            Item oItem=new Item();
			oData = oItem.GetItemPriceLog(CurrentItem);
		...
		{
			this.grdHistory.DisplayLayout.Bands[0].Columns["ID"].Hidden = true;
			this.grdHistory.DisplayLayout.Bands[0].Columns["ChangedIn"].Hidden = true;
			...
			//ugTax.DisplayLayout.Bands[0].Columns[clsPOSDBConstants.fld_UserID].Hidden = true;
            grdHistory.DisplayLayout.Bands[0].Columns["SalePrice"].Format = "#######0.00";
            grdHistory.DisplayLayout.Bands[0].Columns["CostPrice"].Format="#######0.00";
            grdHistory.DisplayLayout.Bands[0].Columns["AddedOn"].Format="MM/dd/yyyy hh:mm tt";
            ...
            grdHistory.DisplayLayout.Bands[0].Columns["SalePrice"].Header.Caption = "Sale Price";
            grdHistory.DisplayLayout.Bands[0].Columns["CostPrice"].Header.Caption = "Cost Price";
            grdHistory.DisplayLayout.Bands[0].Columns["AddedOn"].Header.Caption = "Changed On";
            grdHistory.DisplayLayout.Bands[0].Columns["UserId"].Header.Caption = "Changed By";
            grdHistory.DisplayLayout.Bands[0].Columns["ItemID"].Header.Caption = "Item Code";
		}
		...
		private void frmRptItemPriceLog_Activated(object sender, System.EventArgs e)
		{
