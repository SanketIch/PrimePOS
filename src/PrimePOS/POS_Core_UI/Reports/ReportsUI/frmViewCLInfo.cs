...
namespace POS_Core_UI
{
    ...
    /// </summary>
    public class frmViewCLInfo : System.Windows.Forms.Form
    {
        ...
        private Infragistics.Win.Misc.UltraLabel lblCardDeltail;
        ...
        public frmViewCLInfo(string sCusId,long cardID, bool AlloMultiSelectRow)
        {
            //
            // Required for Windows Form Designer support
            //
            ...
            lblCardDeltail.Text = " Card#: " + cardID + "       Current Points: " + transactionPoints;
            lblCardDeltail.Visible = true;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmViewCLInfo));
            ...
            this.lblCardDeltail = new Infragistics.Win.Misc.UltraLabel();
            ...
            this.tabMainControl.Controls.Add(this.lblCardDeltail);
    ...
    "#  and selected card deactivated.";
            ...
            this.lblCardDeltail.Appearance = appearance2;
            this.lblCardDeltail.BackColorInternal = System.Drawing.Color.Transparent;
            this.lblCardDeltail.BorderStyleInner = Infragistics.Win.UIElementBorderStyle.Solid;
            this.lblCardDeltail.BorderStyleOuter = Infragistics.Win.UIElementBorderStyle.Solid;
            this.lblCardDeltail.Font = new System.Drawing.Font("Verdana", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblCardDeltail.Location = new System.Drawing.Point(13, 5);
            this.lblCardDeltail.Name = "lblCardDeltail";
            this.lblCardDeltail.Size = new System.Drawing.Size(645, 21);
            this.lblCardDeltail.TabIndex = 88;
            this.lblCardDeltail.Text = "Dectivating Card Details";
            this.lblCardDeltail.UseOsThemes = Infragistics.Win.DefaultableBoolean.False;
            this.lblCardDeltail.Visible = false;
            // 
            // chkSelectAll
            // 
            ...
            this.grdSearch.Size = new System.Drawing.Size(972, 389);
            ...
            this.Name = "frmViewCLInfo";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "View Customer Loyalty Summary";
        ...
        private void Search()
        {
            ...
            string sSQL = @"select cc.CardId as [CL Card #],c.CustomerName+', '+c.FirstName [Customer Name]  ,
                            ISNULL(cc.CurrentPoints,0)+ISNULL (cp.Points,0) as [Current Points] ,
                            ISNULL(CouponsCount,0) as [# of Active Coupons] ,ISNULL(cp.CouponValue,0) as 
                            [Total Coupon Value] From Customer c,CL_Cards cc Left Join 
                            (Select CardId,ISNULL(sum(Points),0) as Points , ISNULL(sum(CouponValue),0) as CouponValue ,
                            count(id) as CouponsCount From CL_Coupons Where IsCouponUsed=0  And isActive=1 And 
                            DateAdd(d,ExpiryDays,CreatedOn)>GetDate() Group By CardId) as cp 
                            on cc.CardId=cp.CardId Where cc.CustomerId=c.CustomerId AND cc.IsActive = 1";
            
            if (this.txtCustomer.Text.Trim() != "" && Configuration.convertNullToInt(this.txtCustomer.Tag.ToString()) != 0)
            {
                sSQL += " and c." + clsPOSDBConstants.TransHeader_Fld_CustomerID + " ='" + this.txtCustomer.Tag.ToString().Trim() + "'";
            }
            if (CardID > 0)
            {
                sSQL += " and cc.CardId <> " + CardID;
            }
        ...
        private void frmSearch_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (isCallForDeactivateCard == true)
                {
        ...
        private void btnPrint_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    rptCLCardInfoView rpt = new rptCLCardInfoView();
